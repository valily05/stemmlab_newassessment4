...
export default function Activity6Results() {
  ...
  const normalizedResults = parsedResults.map((item: any, index: number) => ({
    ...
    dominantReactionTime: item.dominantReactionTime ?? 0,
    nonDominantReactionTime: item.nonDominantReactionTime ?? 0,
    tracingAccuracy: item.tracingAccuracy ?? 0,
    tracingDelay: item.tracingDelay ?? 0,
  ...
  const averageReactionTime =
    Number(params.averageReactionTime);
  ...
  const downloadResultsTable = async () => {
    const csvContent = [
      [
        'Iteration',
        'Dominant Reaction Time',
        'Non Dominant Reaction Time',
        'Tracing Accuracy',
        'Tracing Delay',
        'Performance Score',
      ].join(','),
      ...
      ...normalizedResults.map((item: any) =>
        [
          item.iterationNo,
          item.dominantReactionTime,
          item.nonDominantReactionTime,
          item.tracingAccuracy,
          item.tracingDelay,
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity
          ...
          onPress={() => 
            router.push({
              pathname: '/activities/activity6/feedback',
              params: {
